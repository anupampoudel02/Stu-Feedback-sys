            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="name">Module Image</Label>
                        <Input
                            id="image"
                            type="file"
                            required
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            placeholder="Enter module tutor name"
                        />
                        <InputError message={errors.tutor} />
                    </div>
                ...
                <div className="text-muted-foreground text-center text-sm">
                    ...
                    <TextLink href={route('admin.modules.index')} tabIndex={4}>
                        Go to Modules
                    </TextLink>
                </div>
            </form>
